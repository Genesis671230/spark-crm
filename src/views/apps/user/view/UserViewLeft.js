            ...
            <CardContent>
              ...
              <Box sx={{ pt: 2, pb: 1 }}>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  ...
                  <Typography variant='body2'>@{profile.name ? profile.name : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                    Billing Email:
                  </Typography>
                  <Typography variant='body2'>{profile.email ? profile.email : '----'}</Typography>
                </Box>
                ...
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  ...
                  <Typography variant='body2'>{profile.phone ? profile.phone : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Divider sx={{ mt: 4 }} />
                <Box sx={{ display: 'flex', mb: 2.7, justifyContent: 'center' }}>
                ...
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  ...
                  <CustomChip
                    skin='light'
                    size='small'
                    label={shop.verified ? 'Verified' : 'Unverified'}
                    color={'success'}
                    sx={{
                      height: 20,
                      fontSize: '0.75rem',
                ...
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  ...
                  <Typography variant='body2'>{shop.address ? shop.address : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Contact:</Typography>
                  <Typography variant='body2'>{shop.phone ? shop.phone : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Bank Name:</Typography>
                  <Typography variant='body2'>{shop.bank_name ? shop.bank_name : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Bank Account Name:</Typography>
                  <Typography variant='body2'>{shop.bank_acc_name ? shop.bank_acc_name : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Bank Account Number:</Typography>
                  <Typography variant='body2'>{shop.bank_acc_no ? shop.bank_acc_no : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Bank Routing Number:</Typography>
                  <Typography variant='body2'>{shop.bank_routing_no ? shop.bank_routing_no : '----'}</Typography>
                </Box>
                {/* <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                {/* <Box sx={{ display: 'flex' }}>
                  ...
                  <Typography variant='body2'>{shop.country ? shop.country : '----'}</Typography>
                </Box> */}
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Twitter:</Typography>
                  <Typography variant='body2'>{shop.twitter ? shop.twitter : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Facebook:</Typography>
                  <Typography variant='body2'>{shop.facebook ? shop.facebook : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Google:</Typography>
                  <Typography variant='body2'>{shop.google ? shop.google : '----'}</Typography>
                </Box>
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Youtube:</Typography>
                  <Typography variant='body2'>{shop.youtube ? shop.youtube : '----'}</Typography>
                </Box>
              </Box>
            </CardContent>
